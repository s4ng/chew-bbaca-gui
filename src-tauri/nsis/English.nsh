...
; Copy of Tauri's default English translation with only deleteAppData changed.
; See nsis/Korean.nsh for why, and for how to refresh this file.
...
LangString deleteAppData ${LANG_ENGLISH} "Delete all data (schemas and the chewie-env distro included)"
